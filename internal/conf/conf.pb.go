...
type Registry struct {
	...
	Service       *Registry_Service      `protobuf:"bytes,2,opt,name=service,proto3" json:"service,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Registry) GetService() *Registry_Service {
	if x != nil {
		return x.Service
	}
	return nil
...
func (x *Registry_Service) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Registry_Service) ProtoMessage() {}

func (x *Registry_Service) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Registry_Service.ProtoReflect.Descriptor instead.
func (*Registry_Service) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}

func (x *Registry_Service) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Registry_Service) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *Registry_Service) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\bpassword\x18\x05 \x01(\tR\bpassword\"\x88\x02\n" +
	"\bRegistry\x123\n" +
	"\x06consul\x18\x01 \x01(\v2\x1b.kratos.api.Registry.ConsulR\x06consul\x126\n" +
	"\aservice\x18\x02 \x01(\v2\x1c.kratos.api.Registry.ServiceR\aservice\x1a:\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\x1aS\n" +
	"\aService\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\x1a\n" +
	"\bprotocol\x18\x03 \x01(\tR\bprotocolB\x1dZ\x1breview-b/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Registry_Service)(nil),    // 9: kratos.api.Registry.Service
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Registry.service:type_name -> kratos.api.Registry.Service
